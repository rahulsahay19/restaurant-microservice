...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7419425447774953516L;
   ...
   */
  public static org.food.ordering.system.kafka.order.avro.model.Product.Builder newBuilder() {
    return new org.food.ordering.system.kafka.order.avro.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.food.ordering.system.kafka.order.avro.model.Product.Builder newBuilder(org.food.ordering.system.kafka.order.avro.model.Product.Builder other) {
    if (other == null) {
      return new org.food.ordering.system.kafka.order.avro.model.Product.Builder();
    } else {
      return new org.food.ordering.system.kafka.order.avro.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static org.food.ordering.system.kafka.order.avro.model.Product.Builder newBuilder(org.food.ordering.system.kafka.order.avro.model.Product other) {
    if (other == null) {
      return new org.food.ordering.system.kafka.order.avro.model.Product.Builder();
    } else {
      return new org.food.ordering.system.kafka.order.avro.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.food.ordering.system.kafka.order.avro.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.food.ordering.system.kafka.order.avro.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.food.ordering.system.kafka.order.avro.model.Product.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.food.ordering.system.kafka.order.avro.model.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.food.ordering.system.kafka.order.avro.model.Product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.food.ordering.system.kafka.order.avro.model.Product.Builder clearQuantity() {
