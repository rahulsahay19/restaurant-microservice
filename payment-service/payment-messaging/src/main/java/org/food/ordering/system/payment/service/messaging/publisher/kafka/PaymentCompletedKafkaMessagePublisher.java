...
@Slf4j
@Component
//PaymentCompletedMessagePublisher is the output port
public class PaymentCompletedKafkaMessagePublisher implements PaymentCompletedMessagePublisher {
    ...
    public void publish(PaymentCompletedEvent domainEvent) {
        ...
        try {
            ...
            //This is async method, hence callback is required
            kafkaProducer.send(paymentServiceConfigData.getPaymentRequestTopicName(), orderId, paymentResponseAvroModel,
