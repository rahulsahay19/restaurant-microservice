...
public class Order extends AggregateRoot<OrderId> {
    ...
    //These three fields will be set later, hence not final
    ...
    //State changing activities. This will change state from one state to other
    public void pay() {
    ...
    //State changing activities ends here
    ...
    //I have used methods with well-defined names for altering operations instead of setters via inner builder plugin
